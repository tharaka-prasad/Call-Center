                                                ...
                                                <tr key={call.id} className="hover:bg-gray-50/70 transition-colors group">
                                                    ...
                                                    <td className="px-5 py-3.5">
                                                        <div className="flex justify-center gap-1.5">
                                                            <button className="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-semibold text-gray-600 hover:border-gray-900 hover:text-white hover:bg-gray-900 transition-all shadow-sm">
                                                            ...
                                                            <button className="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-semibold text-gray-600 hover:border-emerald-500 hover:text-white hover:bg-emerald-500 transition-all shadow-sm">
                                                                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
